...
public:
    CanSenderNode() : Node("set_vel_gains_s1_node"), vel_gain_data_(0.16), vel_integrator_gain_data_(0.33) {
        ...
        // 初期値設定
        sendCanMessage(0x1b);
        sendCanMessageVelGain(0x004, {0x00, 0x87, 0x01, 0x00});
        sendCanMessageVelIntegratorGain(0x004, {0x00, 0x88, 0x01, 0x00});
